...
Vue.component('event-description', require('./components/EventDescription.vue'));
...
const app = new Vue({
    ...
    data: {
        store: {
            snippets: approvedText.snippets,
            approvedNames: approvedText.names
        },  
